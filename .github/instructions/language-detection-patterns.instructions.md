...
- [text-to-speech/SKILL.md] (strong, implements, bidirectional) - "Primary consumer of detection"
- [accessibility/SKILL.md] (moderate, enables, forward) - "i18n accessibility features"
